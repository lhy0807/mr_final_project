...
class TagsUpdater:
    ...
    def tags_cb(self, tags):
        ...
        for tag in tags.detections:
            ...
            self.tag_estimates[tag_id] = (tag_name, map_tag_pose)

            # visualize tag location
            marker = Marker()
        ...
        for i, est in enumerate(self.tag_estimates):
            if est:
                ...
                t.child_frame_id = est[0]
                t.transform.translation.x = est[1].position.x
                t.transform.translation.y = est[1].position.y
                t.transform.translation.z = est[1].position.z
                t.transform.translation = est[1].orientation
